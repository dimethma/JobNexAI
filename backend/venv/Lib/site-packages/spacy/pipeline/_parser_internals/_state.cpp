...
/* "spacy/pipeline/_parser_internals/_state.pxd":22
...
struct __pyx_t_5spacy_8pipeline_17_parser_internals_6_state_StateC {
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":28
 * 
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":43
 *     int _b_i
 * 
 ...
 *         this.offset = 0
 */
            __pyx_t_3 = PyErr_SetFromErrno(__pyx_builtin_MemoryError); if (unlikely(__pyx_t_3 == ((PyObject *)NULL))) __PYX_ERR(0, 48, __pyx_L10_error)
 ...
 *         this.length = length
 */
            __pyx_t_4 = PyErr_CheckSignals(); if (unlikely(__pyx_t_4 == ((int)-1))) __PYX_ERR(0, 49, __pyx_L10_error)
          }
...
/* "spacy/pipeline/_parser_internals/_state.pxd":62
 *         free(this._heads)
 * 
 *     void set_context_tokens(int* ids, int n) nogil:             # <<<<<<<<<<<<<<
 *         cdef int i, j
...
void __pyx_t_5spacy_8pipeline_17_parser_internals_6_state_StateC::set_context_tokens(int *__pyx_v_ids, int __pyx_v_n) {
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":64
 *     void set_context_tokens(int* ids, int n) nogil:
 *         cdef int i, j
 *         if n == 1:             # <<<<<<<<<<<<<<
 *             if this.B(0) >= 0:
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":68
 *                 ids[0] = this.B(0)
 *             else:
 *                 ids[0] = -1             # <<<<<<<<<<<<<<
 *         elif n == 2:
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":76
 *                 ids[0] = this.B(0)
 *             else:
 *                 ids[0] = -1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":78
 *                 ids[0] = -1
 *             # First word of entity, if any
 *             if this.entity_is_open():             # <<<<<<<<<<<<<<
 *                 ids[1] = this.E(0)
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":81
 *                 ids[1] = this.E(0)
 *             else:
 *                 ids[1] = -1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":83
 *                 ids[1] = -1
 *             # Last word of entity, if within entity
 *             if ids[0] == -1 or ids[1] == -1:             # <<<<<<<<<<<<<<
 *                 ids[2] = -1
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":86
 *                 ids[2] = -1
 *             else:
 *                 ids[2] = ids[0] - 1             # <<<<<<<<<<<<<<
 *         elif n == 8:
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":127
 *             # TODO error =/
 *             pass
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             if ids[i] >= 0:
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":131
 *                 ids[i] += this.offset
 *             else:
 *                 ids[i] = -1             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":133
 *                 ids[i] = -1
 * 
 *     int S(int i) nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":140
 *         return this._stack.at(this._stack.size() - (i+1))
 * 
 *     int B(int i) nogil const:             # <<<<<<<<<<<<<<
 *         if i < 0:
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":146
 *             return this._rebuffer.at(this._rebuffer.size() - (i+1))
 *         else:
 *             b_i = this._b_i + (i - this._rebuffer.size())             # <<<<<<<<<<<<<<
 *             if b_i >= this.length:
 ...
 */
    ...
    /* "spacy/pipeline/_parser_internals/_state.pxd":150
 *                 return -1
 *             else:
 *                 return b_i             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":152
 *                 return b_i
 * 
 *     const TokenC* B_(int i) nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":155
 *         return this.safe_get(this.B(i))
 * 
 *     const TokenC* E_(int i) nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":158
 *         return this.safe_get(this.E(i))
 * 
 *     const TokenC* safe_get(int i) nogil const:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":162
 *             return &this._empty_token
 *         else:
 *             return &this._sent[i]             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":164
 *             return &this._sent[i]
 * 
 *     void map_get_arcs(const unordered_map[int, vector[ArcC]] &heads_arcs, vector[ArcC]* out) nogil const:             # <<<<<<<<<<<<<<
...
void __pyx_t_5spacy_8pipeline_17_parser_internals_6_state_StateC::map_get_arcs(std::unordered_map<int,std::vector<struct __pyx_t_5spacy_8pipeline_17_parser_internals_6_state_ArcC> >  const &__pyx_v_heads_arcs, std::vector<struct __pyx_t_5spacy_8pipeline_17_parser_internals_6_state_ArcC>  *__pyx_v_out) const {
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":166
 *     void map_get_arcs(const unordered_map[int, vector[ArcC]] &heads_arcs, vector[ArcC]* out) nogil const:
 *         cdef const vector[ArcC]* arcs
 *         head_arcs_it = heads_arcs.const_begin()             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":177
 *             incr(head_arcs_it)
 * 
 *     void get_arcs(vector[ArcC]* out) nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":181
 *         this.map_get_arcs(this._right_arcs, out)
 * 
 *     int H(int child) nogil const:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":185
 *             return -1
 *         else:
 *             return this._heads[child]             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":187
 *             return this._heads[child]
 * 
 *     int E(int i) nogil const:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":191
 *             return -1
 *         else:
 *             return this._ents.back().start             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":193
 *             return this._ents.back().start
 * 
 *     int nth_child(const unordered_map[int, vector[ArcC]]& heads_arcs, int head, int idx) nogil const:             # <<<<<<<<<<<<<<
 *         if idx < 1:
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":197
 *             return -1
 * 
 *         head_arcs_it = heads_arcs.const_find(head)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":201
 *             return -1
 * 
 *         cdef const vector[ArcC]* arcs = &deref(head_arcs_it).second             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":205
 *         # Work backwards through arcs to find the arc at the
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":215
 *             incr(arcs_it)
 * 
 *         return -1             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":217
 *         return -1
 * 
 *     int L(int head, int idx) nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":220
 *         return this.nth_child(this._left_arcs, head, idx)
 * 
 *     int R(int head, int idx) nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":223
 *         return this.nth_child(this._right_arcs, head, idx)
 * 
 *     bint empty() nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":226
 *         return this._stack.size() == 0
 * 
 *     bint eol() nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":229
 *         return this.buffer_length() == 0
 * 
 *     bint is_final() nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":232
 *         return this.stack_depth() <= 0 and this.eol()
 * 
 *     int cannot_sent_start(int word) nogil const:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":238
 *             return 1
 *         else:
 *             return 0             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":240
 *             return 0
 * 
 *     int is_sent_start(int word) nogil const:             # <<<<<<<<<<<<<<
 *         if word < 0 or word >= this.length:
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":248
 *             return 1
 *         else:
 *             return 0             # <<<<<<<<<<<<<<
 * 
...
/* "spacy/pipeline/_parser_internals/_state.pxd":250
 *             return 0
 * 
 *     void set_sent_start(int word, int value) nogil:             # <<<<<<<<<<<<<<
 *         if value >= 1:
...
/* "spacy/pipeline/_parser_internals/_state.pxd":254
 *             this._sent_starts.insert(word)
 * 
 *     bint has_head(int child) nogil const:             # <<<<<<<<<<<<<<
...
/* "spacy/pipeline/_parser_internals/_state.pxd":257
 *         return this._heads[child] >= 0
 * 
 *     int l_edge(int word) nogil const:             # <<<<<<<<<<<<<<
 *         return word
...
/* "spacy/pipeline/_parser_internals/_state.pxd":260
 *         return word
 * 
 *     int r_edge(int word) nogil const:             # <<<<<<<<<<<<<<
 *         return word
...
/* "spacy/pipeline/_parser_internals/_state.pxd":263
 *         return word
 * 
 *     int n_arcs(const unordered_map[int, vector[ArcC]] &heads_arcs, int head) nogil const:             # <<<<<<<<<<<<<<
 *         cdef int n = 0
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":269
 *             return n
 * 
 *         cdef const vector[ArcC]* arcs = &deref(head_arcs_it).second             # <<<<<<<<<<<<<<
 *         arcs_it = arcs.const_begin()
 ...
 */
  ...
  /* "spacy/pipeline/_parser_internals/_state.pxd":277
 *             incr(arcs_it)
 * 
 *         return n             # <<<<<<<<<<<<<<
 * 
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5spacy_6lexeme_Lexeme = __Pyx_ImportType_0_29_35(__pyx_t_1, "spacy.lexeme", "Lexeme", sizeof(struct __pyx_obj_5spacy_6lexeme_Lexeme), __PYX_GET_STRUCT_ALIGNMENT_0_29_35(struct __pyx_obj_5spacy_6lexeme_Lexeme),__Pyx_ImportType_CheckSize_Warn_0_29_35); if (!__pyx_ptype_5spacy_6lexeme_Lexeme) __PYX_ERR(2, 15, __pyx_L1_error)
...
static int __Pyx_modinit_variable_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportVoidPtr_0_29_35(__pyx_t_1, "EMPTY_LEXEME", (void **)&__pyx_vp_5spacy_5vocab_EMPTY_LEXEME, "struct __pyx_t_5spacy_7structs_LexemeC") < 0) __PYX_ERR(3, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("spacy.lexeme"); if (!__pyx_t_1) __PYX_ERR(3, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportVoidPtr_0_29_35(__pyx_t_1, "EMPTY_LEXEME", (void **)&__pyx_vp_5spacy_6lexeme_EMPTY_LEXEME, "struct __pyx_t_5spacy_7structs_LexemeC") < 0) __PYX_ERR(3, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr_0_29_35(__pyx_t_1, "OOV_RANK", (void **)&__pyx_vp_5spacy_6lexeme_OOV_RANK, "__pyx_t_5spacy_8typedefs_attr_t") < 0) __PYX_ERR(3, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction_0_29_35(__pyx_t_1, "hash64", (void (**)(void))&__pyx_f_10murmurhash_4mrmr_hash64, "uint64_t (void *, int, uint64_t)") < 0) __PYX_ERR(3, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
